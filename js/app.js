...
function clearListTasks() {
    const listTasks = document.getElementById("list-tasks"); // ul tags in the document
    listTasks.innerHTML = '';
}
 ...
 */
// filter by the id from sidebar navigator
// 4. Filter Tasks needs to control actions in the document
...
// ----- Main ----- //
// 3. Declare Main, which includes task and tasklist
...
// Create Event listener to click or other events
// 5. Event listener to make actions in the dispaly by click one of the options on the left-sidebar
